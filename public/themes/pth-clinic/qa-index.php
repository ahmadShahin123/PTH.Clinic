...
<img src=""<?php echo base_url() . 'themes/pth-clinic/images/logo31.png'; ?>" title="" alt="" />
        ...
        <aside id="slide-out">
                ...
                <div class="post-inner">			
                                <h2 class="entry-title"><a href="answer-inner.php" title="رابط ثابت لـ ما هو نوع التخدير الذي سيتم عند إخراج الأنبوب من العين؟">ما هو نوع التخدير الذي سيتم عند إخراج الأنبوب من العين؟</a></h2>
