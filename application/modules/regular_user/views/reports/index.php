...
$num_columns	= 10;
$can_delete	= $this->auth->has_permission('Regular_user.Reports.Delete');
$can_edit		= $this->auth->has_permission('Regular_user.Reports.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/reports/regular_user/edit/' . $record->reg_user_id, '<span class="icon-pencil"></span> ' .  $record->first_name); ?></td>
				<?php else : ?>
