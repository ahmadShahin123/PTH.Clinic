...
{
    protected $permissionCreate = 'Regular_user.Reports.Create';
    protected $permissionDelete = 'Regular_user.Reports.Delete';
    protected $permissionEdit   = 'Regular_user.Reports.Edit';
    protected $permissionView   = 'Regular_user.Reports.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_regular_user()) {
                ...
                redirect(SITE_AREA . '/reports/regular_user');
            }
