...
{
    protected $permissionCreate = 'Regular_user.Developer.Create';
    protected $permissionDelete = 'Regular_user.Developer.Delete';
    protected $permissionEdit   = 'Regular_user.Developer.Edit';
    protected $permissionView   = 'Regular_user.Developer.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_regular_user()) {
                ...
                redirect(SITE_AREA . '/developer/regular_user');
            }
