...
{
    protected $permissionCreate = 'Excercises.Settings.Create';
    protected $permissionDelete = 'Excercises.Settings.Delete';
    protected $permissionEdit   = 'Excercises.Settings.Edit';
    protected $permissionView   = 'Excercises.Settings.View';
    ...
    public function index($offset = 0)
    {
        ...
        $pagerUriSegment = 5;
        $pagerBaseUrl = site_url(SITE_AREA . '/settings/excercises/index') . '/';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_excercises()) {
                ...
                redirect(SITE_AREA . '/settings/excercises');
            }
