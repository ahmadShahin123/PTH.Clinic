...
{
    protected $permissionCreate = 'Excercises.Developer.Create';
    protected $permissionDelete = 'Excercises.Developer.Delete';
    protected $permissionEdit   = 'Excercises.Developer.Edit';
    protected $permissionView   = 'Excercises.Developer.View';
    ...
    public function index($offset = 0)
    {
        ...
        $pagerUriSegment = 5;
        $pagerBaseUrl = site_url(SITE_AREA . '/developer/excercises/index') . '/';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_excercises()) {
                ...
                redirect(SITE_AREA . '/developer/excercises');
            }
