...
{
    protected $permissionCreate = 'Excercises.Reports.Create';
    protected $permissionDelete = 'Excercises.Reports.Delete';
    protected $permissionEdit   = 'Excercises.Reports.Edit';
    protected $permissionView   = 'Excercises.Reports.View';
    ...
    public function index($offset = 0)
    {
        ...
        $pagerUriSegment = 5;
        $pagerBaseUrl = site_url(SITE_AREA . '/reports/excercises/index') . '/';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_excercises()) {
                ...
                redirect(SITE_AREA . '/reports/excercises');
            }
