...
<div class='admin-box'>
    ...
    <?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
        ...
        <fieldset class='form-actions'>
            ...
            <?php echo lang('bf_or'); ?>
            <?php echo anchor(SITE_AREA . '/developer/excercises', lang('excercises_cancel'), 'class="btn btn-warning"'); ?>
            
            <?php if ($this->auth->has_permission('Excercises.Developer.Delete')) : ?>
                <?php echo lang('bf_or'); ?>
