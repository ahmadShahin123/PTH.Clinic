...
$num_columns	= 10;
$can_delete	= $this->auth->has_permission('Excercises.Settings.Delete');
$can_edit		= $this->auth->has_permission('Excercises.Settings.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/settings/excercises/edit/' . $record->exc_id, '<span class="icon-pencil"></span> ' .  $record->title); ?></td>
				<?php else : ?>
