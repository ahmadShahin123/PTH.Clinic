...
{
    protected $permissionCreate = 'Symptoms.Developer.Create';
    protected $permissionDelete = 'Symptoms.Developer.Delete';
    protected $permissionEdit   = 'Symptoms.Developer.Edit';
    protected $permissionView   = 'Symptoms.Developer.View';
    ...
    public function index($offset = 0)
    {
        ...
        $pagerUriSegment = 5;
        $pagerBaseUrl = site_url(SITE_AREA . '/developer/symptoms/index') . '/';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_symptoms()) {
                ...
                redirect(SITE_AREA . '/developer/symptoms');
            }
