...
{
    protected $permissionCreate = 'Symptoms.Settings.Create';
    protected $permissionDelete = 'Symptoms.Settings.Delete';
    protected $permissionEdit   = 'Symptoms.Settings.Edit';
    protected $permissionView   = 'Symptoms.Settings.View';
    ...
    public function index($offset = 0)
    {
        ...
        $pagerUriSegment = 5;
        $pagerBaseUrl = site_url(SITE_AREA . '/settings/symptoms/index') . '/';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_symptoms()) {
                ...
                redirect(SITE_AREA . '/settings/symptoms');
            }
