...
{
    protected $permissionCreate = 'Symptoms.Content.Create';
    protected $permissionDelete = 'Symptoms.Content.Delete';
    protected $permissionEdit   = 'Symptoms.Content.Edit';
    protected $permissionView   = 'Symptoms.Content.View';
    ...
    public function index($offset = 0)
    {
        ...
        $pagerUriSegment = 5;
        $pagerBaseUrl = site_url(SITE_AREA . '/content/symptoms/index') . '/';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_symptoms()) {
                ...
                redirect(SITE_AREA . '/content/symptoms');
            }
