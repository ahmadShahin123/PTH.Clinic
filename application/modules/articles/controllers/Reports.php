...
{
    protected $permissionCreate = 'Articles.Reports.Create';
    protected $permissionDelete = 'Articles.Reports.Delete';
    protected $permissionEdit   = 'Articles.Reports.Edit';
    protected $permissionView   = 'Articles.Reports.View';
    ...
    public function index($offset = 0)
    {
        ...
        $pagerUriSegment = 5;
        $pagerBaseUrl = site_url(SITE_AREA . '/reports/articles/index') . '/';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_articles()) {
                ...
                redirect(SITE_AREA . '/reports/articles');
            }
