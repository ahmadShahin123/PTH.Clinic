...
{
    protected $permissionCreate = 'Articles.Developer.Create';
    protected $permissionDelete = 'Articles.Developer.Delete';
    protected $permissionEdit   = 'Articles.Developer.Edit';
    protected $permissionView   = 'Articles.Developer.View';
    ...
    public function index($offset = 0)
    {
        ...
        $pagerUriSegment = 5;
        $pagerBaseUrl = site_url(SITE_AREA . '/developer/articles/index') . '/';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_articles()) {
                ...
                redirect(SITE_AREA . '/developer/articles');
            }
