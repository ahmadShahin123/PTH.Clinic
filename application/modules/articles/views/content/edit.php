    ...
    <?php echo form_open_multipart($this->uri->uri_string(), 'class="form-horizontal"'); ?>
        <fieldset>
            ...
            <div class="control-group<?php echo form_error('description') ? ' error' : ''; ?>">
                ...
                <div class='controls'>
                   <textarea id='description'  required='required' name='description'  rows="5" cols="100" maxlength='500' placeholder="write the descriptopn here" wrap="hard" dir="ltr" ><?php echo set_value('description', isset($articles->description) ? $articles->description : ''); ?></textarea>
