...
{
    protected $permissionCreate = 'Excerc.Reports.Create';
    protected $permissionDelete = 'Excerc.Reports.Delete';
    protected $permissionEdit   = 'Excerc.Reports.Edit';
    protected $permissionView   = 'Excerc.Reports.View';
    ...
    public function edit()
    {
        ...
        if (empty($id)) {
            ...
            redirect(SITE_AREA . '/reports/excerc');
        }
