...
{
    protected $permissionCreate = 'Excerc.Content.Create';
    protected $permissionDelete = 'Excerc.Content.Delete';
    protected $permissionEdit   = 'Excerc.Content.Edit';
    protected $permissionView   = 'Excerc.Content.View';
    ...
    public function edit()
    {
        ...
        if (empty($id)) {
            ...
            redirect(SITE_AREA . '/content/excerc');
        }
