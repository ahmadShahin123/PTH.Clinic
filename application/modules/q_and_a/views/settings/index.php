...
$num_columns	= 8;
$can_delete	= $this->auth->has_permission('Q_and_a.Settings.Delete');
$can_edit		= $this->auth->has_permission('Q_and_a.Settings.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/settings/q_and_a/edit/' . $record->q_and_a_id, '<span class="icon-pencil"></span> ' .  $record->question); ?></td>
				<?php else : ?>
