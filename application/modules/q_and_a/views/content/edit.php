    ...
    <?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
        <fieldset>
            ...
            <div class="control-group<?php echo form_error('deleted') ? ' error' : ''; ?>">
                <div class='controls'>
                    <label class='checkbox' for='deleted'>
                        <input type='hidden' id='deleted' name='deleted'  value='1' <?php echo set_checkbox('deleted', 1, isset($q_and_a->deleted) && $q_and_a->deleted == 1); ?> />
            ...
            <div class="control-group<?php echo form_error('deleted_by') ? ' error' : ''; ?>">
                ...
                <div class='controls'>
                    <input id='deleted_by' type='hidden' name='deleted_by' maxlength='11' value="<?php echo set_value('deleted_by', isset($q_and_a->deleted_by) ? $q_and_a->deleted_by : ''); ?>" />
            ...
            <div class="control-group<?php echo form_error('created_on') ? ' error' : ''; ?>">
                ...
                <div class='controls'>
                    <input id='created_on' type='hidden' name='created_on'  value="<?php echo set_value('created_on', isset($q_and_a->created_on) ? $q_and_a->created_on : ''); ?>" />
            ...
            <div class="control-group<?php echo form_error('created_by') ? ' error' : ''; ?>">
                ...
                <div class='controls'>
                    <input id='created_by' type='hidden' name='created_by' maxlength='11' value="<?php echo set_value('created_by', isset($q_and_a->created_by) ? $q_and_a->created_by : ''); ?>" />
            ...
            <div class="control-group<?php echo form_error('modified_on') ? ' error' : ''; ?>">
                ...
                <div class='controls'>
                    <input id='modified_on' type='hidden' name='modified_on'  value="<?php echo set_value('modified_on', isset($q_and_a->modified_on) ? $q_and_a->modified_on : ''); ?>" />
            ...
            <div class="control-group<?php echo form_error('modified_by') ? ' error' : ''; ?>">
                ...
                <div class='controls'>
                    <input id='modified_by' type='hidden' name='modified_by' maxlength='11' value="<?php echo set_value('modified_by', isset($q_and_a->modified_by) ? $q_and_a->modified_by : ''); ?>" />
