...
{
    protected $permissionCreate = 'Q_and_a.Reports.Create';
    protected $permissionDelete = 'Q_and_a.Reports.Delete';
    protected $permissionEdit   = 'Q_and_a.Reports.Edit';
    protected $permissionView   = 'Q_and_a.Reports.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_q_and_a()) {
                ...
                redirect(SITE_AREA . '/reports/q_and_a');
            }
