...
{
    protected $permissionCreate = 'Q_and_a.Developer.Create';
    protected $permissionDelete = 'Q_and_a.Developer.Delete';
    protected $permissionEdit   = 'Q_and_a.Developer.Edit';
    protected $permissionView   = 'Q_and_a.Developer.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_q_and_a()) {
                ...
                redirect(SITE_AREA . '/developer/q_and_a');
            }
